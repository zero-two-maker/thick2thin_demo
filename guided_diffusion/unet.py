...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        # logging.info(f"dims:{dims}, channel_mult:{channel_mult}, model_channels:{model_channels}")
        ...
        if self.num_classes is not None:
            ...
            self.label_emb = LabelEmbedder(num_classes, time_embed_dim, 0.1)
    ...
    def forward(self, x, timesteps, y=None):
        ...
        if self.num_classes is not None:
            ...
            emb = emb + self.label_emb(y, train=False)
